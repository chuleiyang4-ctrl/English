(() => {
  ...
  const createModal = () => {
    ...
    modal.innerHTML = `<section class="auth-card" role="dialog" aria-modal="true" aria-labelledby="auth-title">
      ...
      <div class="auth-signed-out"><h2 id="auth-title">Sign in with Email</h2><p>English lessons are open to everyone. Sign in to use Notebook and sync your learning data.</p>
